package com.example.wkwksama.ojekonline;
...
//                        .setAction("Action", null).show();
    ...
    public static class OrderViewHolder extends RecyclerView.ViewHolder{
        ...
        public OrderViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
            tvDari = (TextView)itemView.findViewById(R.id.txt_recycler_dari);
        }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Order,OrderViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Order, OrderViewHolder>(
            ...
            protected void populateViewHolder(OrderViewHolder viewHolder, Order model, int position) {
                ...
                viewHolder.tvDari.setText("order dari "+model.getDari()+" ke "+model.getKe());

                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mRef.child(postId).child("dari").setValue("Jauh");
                    }
                });
